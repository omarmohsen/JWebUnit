/* Generated By:JavaCC: Do not edit this line. JWebUnitGeneratorTokenManager.java */
package net.sourceforge.jwebunit.javacc;
import java.io.*;
import java.util.*;

/** Token Manager. */
public class JWebUnitGeneratorTokenManager implements JWebUnitGeneratorConstants
{
...
/** Constructor. */
public JWebUnitGeneratorTokenManager(JavaCharStream stream){
...
/** Constructor. */
public JWebUnitGeneratorTokenManager(JavaCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
