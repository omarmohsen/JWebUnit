/* Generated By:JavaCC: Do not edit this line. WebTestCaseGeneratorTokenManager.java */
package net.sourceforge.jwebunit.javacc;
import java.io.*;
import java.util.*;

/** Token Manager. */
public class WebTestCaseGeneratorTokenManager implements WebTestCaseGeneratorConstants
{
...
/** Constructor. */
public WebTestCaseGeneratorTokenManager(JavaCharStream stream){
...
/** Constructor. */
public WebTestCaseGeneratorTokenManager(JavaCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
