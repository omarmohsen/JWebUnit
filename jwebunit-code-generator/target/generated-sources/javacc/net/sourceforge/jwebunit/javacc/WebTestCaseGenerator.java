/* Generated By:JavaCC: Do not edit this line. WebTestCaseGenerator.java */
 ...
 */
public class WebTestCaseGenerator implements WebTestCaseGeneratorConstants {
   /**
 ...
 */
  final public void CompilationUnit(StringBuffer sb) throws ParseException {
   sb.append(getToken(1).specialToken.image).append("\u005cn");
   ...
   sb.append("import java.awt.Image;\u005cn");
  sb.append("import java.io.File;\u005cn");
  sb.append("import java.io.PrintStream;\u005cn");
  sb.append("import java.util.List;\u005cn");
  sb.append("import java.util.Map;\u005cn");
  sb.append("import java.net.URL;\u005cn\u005cn");
  sb.append("import net.sourceforge.jwebunit.api.HttpHeader;\u005cn");
  sb.append("import net.sourceforge.jwebunit.api.IElement;\u005cn");
  sb.append("import net.sourceforge.jwebunit.api.ITestingEngine;\u005cn");
  sb.append("import net.sourceforge.jwebunit.exception.TestingEngineResponseException;\u005cn");
  sb.append("import net.sourceforge.jwebunit.html.Table;\u005cn");
  sb.append("import net.sourceforge.jwebunit.util.TestContext;\u005cn\u005cn");
  sb.append("import junit.framework.TestCase;\u005cn\u005cn");
    label_1:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case IMPORT:
   ...
   sb.append("/**\u005cn");
  sb.append(" * Deprecated: use JUnit 4 and {@link JWebUnit} instead.\u005cn");
  sb.append(" * Superclass for JUnit 3 TestCases which provides web application navigation and \u005cn");
  sb.append(" * JUnit assertions. This class uses and is generated from {@link net.sourceforge.jwebunit.junit.WebTester}.\u005cn");
  sb.append(" * \u005cn");
  sb.append(" * @author JavaCC\u005cn");
  sb.append(" */\u005cn");
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  final public void PackageDeclaration(StringBuffer sb) throws ParseException {
 String name;
    jj_consume_token(PACKAGE);
    name = Name();
    jj_consume_token(SEMICOLON);
   sb.append("package ").append(name).append(";\u005cn\u005cn");
  }

  final public void ImportDeclaration(StringBuffer sb) throws ParseException {
 ...
 */
  final public Object[] Modifiers() throws ParseException {
   int modifiers = 0;
   String annotations = "";
    label_3:
    while (true) {
    ...
    {if (true) return new Object[] {modifiers, annotations};}
 ...
 */
  final public void TypeDeclaration(StringBuffer sb) throws ParseException {
  ...
  final public void ClassOrInterfaceDeclaration(int modifiers, StringBuffer sb) throws ParseException {
   ...
   sb.append("@Deprecated\u005cnpublic abstract class WebTestCase extends TestCase ");
  ...
  final public void ClassOrInterfaceBody(boolean isInterface, StringBuffer sb) throws ParseException {
   sb.append("{\u005cn");
  sb.append("    protected WebTester tester = null;\u005cn\u005cn");
  sb.append("    protected WebTester customTester = null;\u005cn\u005cn");
  sb.append("    /***\u005cn");
  sb.append("      * From 2.1 you can provide your own WebTester to run test cases.\u005cn");
  sb.append("      */\u005cn");
  sb.append("    public WebTestCase(WebTester customTester) {\u005cn");
  sb.append("        super();\u005cn");
  sb.append("        this.customTester = customTester;\u005cn");
  sb.append("    }\u005cn\u005cn");
  sb.append("    public WebTestCase(String name, WebTester customTester) {\u005cn");
  sb.append("        super(name);\u005cn");
  sb.append("        this.customTester = customTester;\u005cn");
  sb.append("    }\u005cn\u005cn");
  sb.append("    public WebTestCase(String name) {\u005cn");
  sb.append("        super(name);\u005cn");
  sb.append("    }\u005cn\u005cn");
  sb.append("    public WebTestCase() {\u005cn");
  sb.append("        super();\u005cn");
  sb.append("    }\u005cn\u005cn");

  sb.append("    protected void tearDown() throws Exception {\u005cn");
  sb.append("        closeBrowser();\u005cn");
  sb.append("        super.tearDown();\u005cn");
  sb.append("    }\u005cn\u005cn");

  sb.append("    /**\u005cn");
  sb.append("     * Get internal WebTester.\u005cn");
  sb.append("     */\u005cn");
  sb.append("    public WebTester getTester() {\u005cn");
  sb.append("        return this.tester;\u005cn");
  sb.append("    }\u005cn\u005cn");

  sb.append("    /**\u005cn");
  sb.append("     * Clean up unused memory. Using <tt>setUp</tt> and <tt>tearDown</tt> is\u005cn");
  sb.append("     * not an option for this requires the subclasses of this class to call the\u005cn");
  sb.append("     * respective <tt>super</tt> methods.\u005cn");
  sb.append("     *\u005cn");
  sb.append("     * <p>Original patch contributed by Budi Boentaran.\u005cn");
  sb.append("     */\u005cn");
  sb.append("    public void runBare() throws Throwable {\u005cn");
  sb.append("        try {\u005cn");
  sb.append("            if (customTester == null)\u005cn");
  sb.append("                tester = new WebTester();\u005cn");
  sb.append("            else\u005cn");
  sb.append("                tester = customTester;\u005cn");
  sb.append("            super.runBare();\u005cn");
  sb.append("        } finally {\u005cn");
  sb.append("            tester = null;\u005cn");
  sb.append("            customTester = null;\u005cn");
  sb.append("        }\u005cn");
  sb.append("    }\u005cn\u005cn");
    jj_consume_token(LBRACE);
    label_10:
  ...
  final public void ClassOrInterfaceBodyDeclaration(boolean isInterface, StringBuffer sb) throws ParseException {
 ...
 Token t;
  ...
  final public void MethodDeclaration(int modifiers, StringBuffer sb, String comment, String annotations) throws ParseException {
  boolean append;
  String resultType;
  List params;
  String throwsList;
  boolean isVoid;
    ...
    if (append && comment!=null) sb.append("    ").append(comment).append("\u005cn");
    if (append && annotations!=null && !"".equals(annotations)) sb.append("    ").append(annotations).append("\u005cn");
    ...
    params = MethodDeclarator(append, sb);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case THROWS:
      jj_consume_token(THROWS);
      throwsList = NameList();
                                                                        if (append) sb.append("throws "+throwsList);
      break;
    default:
      ;
    }
   ...
   if (append) {
    ...
    sb.append(");\u005cn");
    sb.append("        } catch (org.junit.ComparisonFailure e) {\u005cn");
    sb.append("            throw new junit.framework.ComparisonFailure(e.getMessage(), e.getExpected(), e.getActual());\u005cn");
    sb.append("        } catch (java.lang.AssertionError e) {\u005cn");
    sb.append("            throw new junit.framework.AssertionFailedError(e.getMessage());\u005cn");
    sb.append("        }\u005cn");
    sb.append("    }\u005cn\u005cn");
  }
  }

  final public List MethodDeclarator(boolean append, StringBuffer sb) throws ParseException {
 Token t;
List result;
    t = jj_consume_token(IDENTIFIER);
                  if(append) sb.append(t.image);
    result = FormalParameters(append, sb);
    label_14:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case LBRACKET:
   ...
   result.add(0, t.image); {if (true) return result;}
    throw new Error("Missing return statement in function");
  }

  final public List FormalParameters(boolean append, StringBuffer sb) throws ParseException {
 ...
 List tmp;
    ...
    case IDENTIFIER:
      tmp = FormalParameter();
                                                            result.add(tmp.get(0)); result.add(tmp.get(1)); if (append) {sb.append(tmp.get(0)).append(" ").append(tmp.get(1));}
      label_15:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case COMMA:
  ...
  final public List FormalParameter() throws ParseException {
 ...
 */
 ...
 StringBuffer sb = new StringBuffer();
  ...
  final public boolean ResultType(boolean append, StringBuffer sb) throws ParseException {
 String result;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case VOID:
      jj_consume_token(VOID);
          if (append) sb.append("void "); {if (true) return true;}
      break;
    case BOOLEAN:
    case BYTE:
    case CHAR:
    ...
    case IDENTIFIER:
      result = Type();
                 if (append) sb.append(result+" "); {if (true) return false;}
      break;
    default:
      jj_consume_token(-1);
      throw new ParseException();
...
/* Annotation syntax follows. */
  ...
  final public void NormalAnnotation(StringBuffer sb) throws ParseException {
    String name;
    String member = "";
    jj_consume_token(AT);
    name = Name();
  ...
  final public void MarkerAnnotation(StringBuffer sb) throws ParseException {
    String name;
    jj_consume_token(AT);
    name = Name();
  ...
  final public void SingleMemberAnnotation(StringBuffer sb) throws ParseException {
    String name;
    String member = "";
    jj_consume_token(AT);
    name = Name();
  ...
  final public String MemberValuePairs() throws ParseException {
  StringBuffer sb = new StringBuffer();
  String member;
    member = MemberValuePair();
                             sb.append(member);
    label_44:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  final public String MemberValuePair() throws ParseException {
        Token t;
        String member;
    t = jj_consume_token(IDENTIFIER);
    jj_consume_token(ASSIGN);
    member = MemberValue();
     {if (true) return t.image + "=" + member;}
    throw new Error("Missing return statement in function");
  }

  final public String MemberValue() throws ParseException {
        String result= "";
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case AT:
      result = Annotation();
  ...
  final public String MemberValueArrayInitializer() throws ParseException {
    StringBuffer sb = new StringBuffer();
    String member;
    jj_consume_token(LBRACE);
    member = MemberValue();
...
/* Annotation Types. */
  ...
  public WebTestCaseGenerator(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public WebTestCaseGenerator(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new JavaCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new WebTestCaseGeneratorTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
  }
  ...
  /** Constructor. */
  public WebTestCaseGenerator(java.io.Reader stream) {
