...
/**
    ...
    public void setUrlandAgent(String url,String agent) {
    	...
    	getTestContext().setUserAgent(searchUserAgent(agent));
    }
...
String Default="Mozilla/5.0 (Windows NT 6.1; rv:11.0) Gecko/20100101 Firefox/11.0";
String Agent = new String();
 char ag=agent.charAt(0);
 switch (ag) {
            case 'u':    Agent="Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:24.0) Gecko/20100101 Firefox/24.0" ;
                     break;
            case 'i':    Agent= "Mozilla/5.0 (iPhone; CPU iPhone OS 5_1 like Mac OS X) AppleWebKit/534.46 (KHTML, like Gecko) Version/5.1 Mobile/9B179 Safari/7534.48.3";
                     break;
            case 'g': Agent="Googlebot/2.1 (+http://www.googlebot.com/bot.html)";
                     break;
            case 'y':     Agent= "Mozilla/5.0 (compatible; Yahoo! Slurp; http://help.yahoo.com/help/us/ysearch/slurp)";
                     break;
            case 'b':      Agent= "Mozilla/5.0 (compatible; bingbot/2.0; +http://www.bing.com/bingbot.htm)";
                     break;
            case 'e':        Agent= "Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; Trident/5.0)";
                     break;
           default:         Agent="Mozilla/5.0 (Windows NT 6.1; rv:11.0) Gecko/20100101 Firefox/11.0";
        }
return Agent; 
